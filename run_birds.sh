...
python scripts/fit_bird_june.py --n_days 30 -p all \
    -d cuda:5 --n_epochs 1000 --data_calibrate cases_per_timestep -w 0.01 \
    --data_path ./data/london_synth.csv --june_config configs/bird_june.yaml \
    --results_path ./london_results --n_samples_per_epoch 1 --diff_mode forward \
    --chunk_size 0
